-- Track which projects pulled which artifacts (denormalized per-project usage stats).
-- Upserted with debounce (sync.Map + 30s flush) to avoid hot-path write contention.
